...
from swift.template.vision_utils import image_to_base64_url
        ...
        def _process_image_data(image_data: Union[dict, str]) -> str:
            if isinstance(image_data, dict):
                ...
                if image_data.get('path'):
                    ...
                    return path
            elif isinstance(image_data, str) and image_data.startswith('s3://'):
                return image_to_base64_url(image_data)
            return image_data
