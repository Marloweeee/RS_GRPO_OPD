...
class GRPOArgumentsMixin(RolloutTrainerArgumentsMixin):
    ...
    # SDPO/OPSD correction for bbox GRPO rollouts.
    use_sdpo: bool = False
    sdpo_lambda: float = 0.0
    sdpo_tau_good: float = 0.5
    ...
    sdpo_sibling_fallback: Literal['gt', 'skip'] = 'gt'
    sdpo_teacher_refresh_mode: Literal['fixed', 'metric', 'metric_ewma', 'off'] = 'fixed'
    sdpo_teacher_refresh_step: int = -1
    sdpo_teacher_refresh_warmup: int = 80
    sdpo_teacher_refresh_window: int = 50
    sdpo_teacher_refresh_check_interval: int = 10
    sdpo_teacher_refresh_min_iou_improve: float = 0.01
    sdpo_teacher_refresh_max_failed: float = 0.55
    sdpo_teacher_refresh_min_sdpo_loss: float = 0.02
    sdpo_teacher_refresh_max_kl: float = 0.30
    sdpo_teacher_refresh_short_window: int = 20
    sdpo_teacher_refresh_long_window: int = 80
    sdpo_teacher_refresh_ewma_alpha: float = 0.10
    sdpo_teacher_refresh_consecutive_checks: int = 2
    sdpo_teacher_refresh_min_short_long_iou_gain: float = 0.006
    sdpo_teacher_refresh_min_ewma_iou_gain: float = 0.008
    sdpo_teacher_refresh_max_iou05_drop: float = 0.010
    sdpo_teacher_refresh_max_refreshes: int = 1
    sdpo_teacher_refresh_cooldown_steps: int = 0
