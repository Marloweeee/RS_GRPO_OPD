...
from swift.custom_utils.ground_func import calculate_pred_norm_point, pointnorm2real
...
def compute_screenspotv2(data_list, metric):
    ...
    for platform in ['mobile', 'desktop', 'web']:
        ...
        print(f"  {platform}: overall={platform_metrics['overall']}%, "
              f"text={platform_metrics['text']}%, icon={platform_metrics['icon']}%")
