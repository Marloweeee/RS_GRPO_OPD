...
class SwiftRLHF(SwiftSft):
    ...
    def _prepare_template(self) -> None:
        ...
        mode_mapping = {'kto': 'kto', 'gkd': 'train', 'ppo': 'transformers', 'grpo': 'train', 'opsd': 'train'}
    ...
    def _get_trainer_kwargs(self):
        ...
        # add
        if self.args.rlhf_type == 'opsd' and self.args.teacher_deepspeed:
            trainer_kwargs['teacher_deepspeed_config'] = self.args.teacher_deepspeed
        if self.args.rlhf_type == 'grpo' and getattr(self.args, 'use_sdpo', False) and self.args.teacher_deepspeed:
            trainer_kwargs['teacher_deepspeed_config'] = self.args.teacher_deepspeed
