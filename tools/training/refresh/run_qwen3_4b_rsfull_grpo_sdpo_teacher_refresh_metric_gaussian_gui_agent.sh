...
# Mask mode: gaussian. The ref model stays at the base checkpoint.
set -euo pipefail
...
export EXPERIMENT_SLUG="${EXPERIMENT_SLUG:-teacher-refresh-metric-gaussian}"
export RUN_NAME="${RUN_NAME:-gui-sd-qwen3-4b-rsfull_grpo_sdpo_teacher_refresh_metric_gaussian_e1-${timestamp}}"
export RJOB_NAME="${RJOB_NAME:-q4b-trmetric-gauss-2n-${timestamp}}"
...
export VLLM_SERVER_PORT="${VLLM_SERVER_PORT:-8492}"
