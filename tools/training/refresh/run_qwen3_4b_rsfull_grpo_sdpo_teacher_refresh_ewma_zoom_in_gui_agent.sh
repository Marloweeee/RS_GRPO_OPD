#!/usr/bin/env bash
# Qwen3-VL-4B rs_full GRPO+SDPO with one-shot EWMA/dual-window teacher refresh.
...
export EXPERIMENT_SLUG="${EXPERIMENT_SLUG:-teacher-refresh-ewma-zoom-in}"
export RUN_NAME="${RUN_NAME:-gui-sd-qwen3-4b-rsfull_grpo_sdpo_teacher_refresh_ewma_zoom_in_e1-${timestamp}}"
export RJOB_NAME="${RJOB_NAME:-q4b-trewma-zoom-2n-${timestamp}}"
...
export VLLM_SERVER_PORT="${VLLM_SERVER_PORT:-8792}"
export MASTER_PORT="${MASTER_PORT:-30000}"
