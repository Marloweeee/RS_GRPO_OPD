#!/usr/bin/env bash
# Qwen3-VL-4B rs_full GRPO+SDPO with in-process teacher refresh at step 80.
...
export EXPERIMENT_SLUG="${EXPERIMENT_SLUG:-teacher-refresh-s80-gaussian}"
export RUN_NAME="${RUN_NAME:-gui-sd-qwen3-4b-rsfull_grpo_sdpo_teacher_refresh_s80_gaussian_e1-${timestamp}}"
export RJOB_NAME="${RJOB_NAME:-q4b-trs80-gauss-2n-${timestamp}}"
...
export VLLM_SERVER_PORT="${VLLM_SERVER_PORT:-8392}"
