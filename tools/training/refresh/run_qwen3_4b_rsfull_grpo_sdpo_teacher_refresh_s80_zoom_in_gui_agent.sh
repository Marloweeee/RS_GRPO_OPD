...
export EXPERIMENT_SLUG="${EXPERIMENT_SLUG:-teacher-refresh-s80-zoom-in}"
export RUN_NAME="${RUN_NAME:-gui-sd-qwen3-4b-rsfull_grpo_sdpo_teacher_refresh_s80_zoom_in_e1-${timestamp}}"
export RJOB_NAME="${RJOB_NAME:-q4b-trs80-zoom-2n-${timestamp}}"
